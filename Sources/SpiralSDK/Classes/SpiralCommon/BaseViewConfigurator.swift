...
extension Configurable {
    ...
    public var shouldAttemptOptimization: Bool {
        return false
    }
    
    public func precalculateLayoutWith(_ data: DataType) -> CGSize? {
...
public class BaseViewConfigurator<ConfigurableType: Configurable>: ViewConfigurator {
    ...
    public var data: ConfigurableType.DataType
    ...
    public init(data: ConfigurableType.DataType, didSelectAction: (() -> Void)? = nil) {
        self.data = data
