...
extension QueryInterfaceRequest where RowDecoder: Swift.Identifiable, RowDecoder.ID: DatabaseValueConvertible {
...
@available(iOS 13, macOS 10.15, tvOS 13, watchOS 6, *)
extension Table where RowDecoder: Swift.Identifiable, RowDecoder.ID: DatabaseValueConvertible {
    @available(*, unavailable, message: "selectID() has been removed. You may use selectPrimaryKey(as:) instead.")
    public func selectID() -> QueryInterfaceRequest<RowDecoder.ID> { preconditionFailure() }
}

@available(iOS 13, macOS 10.15, tvOS 13, watchOS 6, *)
extension TableRecord where Self: Swift.Identifiable, ID: DatabaseValueConvertible {
    @available(*, unavailable, message: "selectID() has been removed. You may use selectPrimaryKey(as:) instead.")
