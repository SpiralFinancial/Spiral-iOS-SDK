...
public final class DatabaseSnapshotPool {
    public let configuration: GRDBConfiguration
    ...
    public init(_ db: Database, configuration: GRDBConfiguration? = nil) throws {
        ...
        var holderConfig = GRDBConfiguration()
    ...
    /// - throws: A ``DatabaseError`` whenever an SQLite error occurs.
    public init(path: String, configuration: GRDBConfiguration = GRDBConfiguration()) throws {
    ...
    private static func configure(_ configuration: GRDBConfiguration) -> GRDBConfiguration {
