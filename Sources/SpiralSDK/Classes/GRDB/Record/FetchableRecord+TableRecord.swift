...
extension FetchableRecord where Self: TableRecord & Swift.Identifiable, ID: DatabaseValueConvertible {
...
@available(iOS 13, macOS 10.15, tvOS 13, watchOS 6, *)
extension FetchableRecord where Self: TableRecord & Hashable & Swift.Identifiable, ID: DatabaseValueConvertible {
    /// Returns a set of records identified by their primary keys.
    ///
    /// For example:
    ///
