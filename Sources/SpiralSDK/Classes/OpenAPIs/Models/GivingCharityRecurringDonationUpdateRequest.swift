//
// GivingCharityRecurringDonationUpdateRequest.swift
//
...
public struct GivingCharityRecurringDonationUpdateRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(accountId: String, charityId: String, startDate: Date, donationAmount: Double, isPaused: Bool, isStopped: Bool, isAnonymous: Bool, coverFees: Bool, id: String) {
