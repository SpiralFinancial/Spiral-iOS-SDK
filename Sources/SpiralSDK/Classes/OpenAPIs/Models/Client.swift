...
public struct Client: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, logo: String? = nil, fintechName: String, contractStart: Int64? = nil, contractEnd: Int64? = nil, manager: String? = nil, brandName: String? = nil, contactUser: User? = nil, clientSettings: ClientSettings? = nil, products: ClientProducts) {
        self.id = id
        self.logo = logo
