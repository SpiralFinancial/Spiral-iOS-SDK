//
// ClientImpactProcessRequest.swift
//
...
public struct ClientImpactProcessRequest: Codable, JSONEncodable, Hashable {
    ...
    /** List of Spiral transaction IDs to process. Optional, but if provided will overwrite the supplied filters and only process these donation IDs. */
