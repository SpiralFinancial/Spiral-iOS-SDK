//
// TransactionImpactResponse.swift
//
...
/** A single Impact from performing a financial transaction. */
public struct TransactionImpactResponse: Codable, JSONEncodable, Hashable {
