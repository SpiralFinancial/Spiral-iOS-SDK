...
public struct RewardSettings: Codable, JSONEncodable, Hashable {
    ...
    public var userSponsoredValue: RoundUpSelections?
    ...
    public init(type: ModelType, userSponsoredRewardType: UserSponsoredRewardType? = nil, userSponsoredValue: RoundUpSelections? = nil, userSponsoredRewardLimits: RewardLimits? = nil, bankSponsoredRewardType: BankSponsoredRewardType? = nil, value: Double? = nil) {
        self.type = type
