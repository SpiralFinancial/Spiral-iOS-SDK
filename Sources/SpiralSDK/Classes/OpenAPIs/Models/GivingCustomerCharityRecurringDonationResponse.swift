...
public struct GivingCustomerCharityRecurringDonationResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(accountId: String, charityId: String, startDate: Int64, amount: Double, paused: Bool, stopped: Bool, anonymous: Bool, coverFees: Bool, id: String, nextDate: Int64? = nil, iconUrl: String? = nil) {
