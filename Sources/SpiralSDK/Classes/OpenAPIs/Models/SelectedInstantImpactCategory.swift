//
// SelectedInstantImpactCategory.swift
//
...
/** Lightweight Instant Impact Category with attributes selected by client */
public struct SelectedInstantImpactCategory: Codable, JSONEncodable, Hashable {
