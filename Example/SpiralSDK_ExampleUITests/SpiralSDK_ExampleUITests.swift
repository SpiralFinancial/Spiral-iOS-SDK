//
//  SpiralSDK_ExampleUITests.swift
//  SpiralSDK_ExampleUITests
//
...
class SpiralSDK_ExampleUITests: XCTestCase {
    ...
    func testExit() throws {
        ...
        app.tables/*@START_MENU_TOKEN@*/.staticTexts["Fetch Spiral Token"]/*[[".cells",".buttons[\"Fetch Spiral Token\"].staticTexts[\"Fetch Spiral Token\"]",".staticTexts[\"Fetch Spiral Token\"]"],[[[-1,2],[-1,1],[-1,0,1]],[[-1,2],[-1,1]]],[0]]@END_MENU_TOKEN@*/.tap()
