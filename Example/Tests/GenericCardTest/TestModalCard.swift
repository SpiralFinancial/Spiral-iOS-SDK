...
struct TestModalCard: GenericCardTestModelProtocol {
    ...
    var cardModel: GenericCardModel? {
        let title = SpiralGenericCardTextComponent(html: "<span style=\"font-family: sfpro-regular; font-size:22px; line-height: 22px; color:black;\">Introducing Social Impact<br />Rewards</span>",
                                             alignment: .center)
        ...
        let titleImage = SpiralGenericCardImageComponent(url: "https://res.cloudinary.com/spiral/image/upload/v1649263862/generic-card-images/spiral-debitcard-angled.png",
                                              fixedHeight: 98)
        ...
        let restaurantImage = SpiralGenericCardImageComponent(url: "https://res.cloudinary.com/spiral/image/upload/v1649262045/generic-card-images/sr-coffee.png",
                                                  fixedWidth: 50,
                                                  fixedHeight: 50,
                                                  contentMode: .aspectFit)
        let restaurantImageComponent = SpiralGenericCardComponent(type: .image,
                                                      padding: SpiralGenericCardContentPadding(left: 10, right: 18, top: 0, bottom: 0),
                                                      content: restaurantImage)
        
        let restaurantImageContainer = SpiralGenericCardComponentContainer(children: [restaurantImageComponent])
        let restaurantImageContainerComponent = SpiralGenericCardComponent(type: .container,
                                                               fixedWidth: 78,
                                                               content: restaurantImageContainer)
        
        let restaurantText = SpiralGenericCardTextComponent(html:
                                                """
        ...
        let restaurantTextComponent = SpiralGenericCardComponent(type: .text,
                                                 padding: SpiralGenericCardContentPadding(left: 0, right: 10, top: 0, bottom: 0),
                                                 content: restaurantText)
        
        let restaurantContainer = SpiralGenericCardComponentContainer(axis: .horizontal, children: [restaurantImageContainerComponent, restaurantTextComponent])
        let restaurantComponent = SpiralGenericCardComponent(type: .container, padding: SpiralGenericCardContentPadding(left: 32, right: 32, top: 20, bottom: 0), content: restaurantContainer)
        
        // Water
        
        let waterImage = SpiralGenericCardImageComponent(url: "https://res.cloudinary.com/spiral/image/upload/v1649262045/generic-card-images/sr-water.png",
                                                  fixedWidth: 50,
                                                  fixedHeight: 50,
                                                  contentMode: .aspectFit)
        let waterImageComponent = SpiralGenericCardComponent(type: .image,
                                                      padding: SpiralGenericCardContentPadding(left: 10, right: 18, top: 0, bottom: 0),
                                                      content: waterImage)
        
        let waterImageContainer = SpiralGenericCardComponentContainer(children: [waterImageComponent])
        let waterImageContainerComponent = SpiralGenericCardComponent(type: .container,
                                                               fixedWidth: 78,
                                                               content: waterImageContainer)
        
        let waterText = SpiralGenericCardTextComponent(html:
                                                """
        ...
        let waterTextComponent = SpiralGenericCardComponent(type: .text,
                                                 padding: SpiralGenericCardContentPadding(left: 0, right: 10, top: 0, bottom: 0),
                                                 content: waterText)
        
        let waterContainer = SpiralGenericCardComponentContainer(axis: .horizontal, children: [waterImageContainerComponent, waterTextComponent])
        let waterComponent = SpiralGenericCardComponent(type: .container, padding: SpiralGenericCardContentPadding(left: 32, right: 32, top: 20, bottom: 0), content: waterContainer)
        
        
        // Shelter
        
        let shelterImage = SpiralGenericCardImageComponent(url: "https://res.cloudinary.com/spiral/image/upload/v1649262045/generic-card-images/sr-roof.png",
                                                  fixedWidth: 50,
                                                  fixedHeight: 50,
                                                  contentMode: .aspectFit)
        let shelterImageComponent = SpiralGenericCardComponent(type: .image,
                                                      padding: SpiralGenericCardContentPadding(left: 10, right: 18, top: 0, bottom: 0),
                                                      content: shelterImage)
        
        let shelterImageContainer = SpiralGenericCardComponentContainer(children: [shelterImageComponent])
        let shelterImageContainerComponent = SpiralGenericCardComponent(type: .container,
                                                               fixedWidth: 78,
                                                               content: shelterImageContainer)
        
        let shelterText = SpiralGenericCardTextComponent(html:
                                                """
        ...
        let shelterTextComponent = SpiralGenericCardComponent(type: .text,
                                                 padding: SpiralGenericCardContentPadding(left: 0, right: 10, top: 0, bottom: 0),
                                                 content: shelterText)
        
        let shelterContainer = SpiralGenericCardComponentContainer(axis: .horizontal, children: [shelterImageContainerComponent, shelterTextComponent])
        let shelterComponent = SpiralGenericCardComponent(type: .container, padding: SpiralGenericCardContentPadding(left: 32, right: 32, top: 20, bottom: 0), content: shelterContainer)
